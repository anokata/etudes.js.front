...
const routes = [
    ...
    { path: "/idler02", component: Idler02 },
    {
        path: "/About",
        component: About,
        props: { data: "saf", x: 1, sharedState: sharedState },
    },
...
Vue.component("v-button", {
    ...
    methods: {},
    template:
        '<button class="btn btn-primary" :class="\'btn-\'+type" @click="handler(\'save\'+type)" >{{message}}</button>',
});
...
Vue.component("click-button", {
    ...
    template:
        '<button class="btn btn-outline-info" @click="clickfn()">{{message}}<img src="icons/grayblock_v2.png" height=20></img></button>',
});
