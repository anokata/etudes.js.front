...
Что если невозможно выдать запрошенную сумму в купюрах ровно?
При чём здесь копейки и запятая если номинал минимум 50?

Если может быть загружено неравномерно то как тратить равномерно?

onload - focus on main
вывод остатка от запрошенного
(любые символы кроме цифр и запятой игнорируются),
настройки: заполнить варианты, отдельным окном
кнопка справки иконкой
анимации, иконки
новая версия
